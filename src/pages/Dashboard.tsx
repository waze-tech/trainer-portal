...
function StatCard({ icon, label, value, accent }: {
  ...
  return (
    <Card className="flex items-start gap-4">
      <div className={`w-12 h-12 rounded-xl flex items-center justify-center shrink-0 ${accent || 'bg-primary/10 text-primary'}`}>
        {icon}
      </div>
      <div>
    ...
    <div>
      ...
      <main className="p-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h2 className="text-xl font-semibold text-neutral-900">Welcome back, Mike</h2>
        ...
        <Card padding="none">
          <div className="px-6 py-4 border-b border-neutral-200 flex items-center justify-between">
            <h3 className="font-semibold text-neutral-900">Recent Sessions</h3>
            <Link to="/sessions" className="text-sm text-primary font-medium hover:text-primary-dark flex items-center gap-1">
